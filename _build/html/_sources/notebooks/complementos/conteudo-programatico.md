# Plano de Curso: Gerenciamento de Projetos - baseado no PMBOK 7ª Edição
...
4. **Aluno 4 - Planejamento Estratégico e Preparação para Gestão de Riscos**
   - Conteúdo Principal:
...
2. **Aluno 2**: Gestão de Stakeholders
